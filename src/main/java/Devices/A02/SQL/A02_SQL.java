...
public class A02_SQL {
    ...
    public void insertValuesA02(float temperature, float humidity, float pressure) {
    ...
    public long[] selectDatabaseIntervalA02() {
        ...
        try {
            ...
            String sql = "select * from Device_database_interval WHERE `id`='A02'";
    ...
    public boolean updateDatabaseIntervalA02(int inputValue) {
    ...
    public ArrayList<String> selectA02Data(int amountOfDatesBeforeToday) {
        ...
        try {
            ...
            stmt = conn.createStatement();
            String sql;
            sql = "select * from Temperature WHERE `id`='A02' AND `timestamp` >= DATE_SUB(CURDATE(), INTERVAL "
